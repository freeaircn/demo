...
CREATE TABLE `users` (
  ...
  `dept_level_1` varchar(30) DEFAULT NULL,
  `dept_level_2` varchar(30) DEFAULT NULL,
  `dept_level_3` varchar(30) DEFAULT NULL,
  `dept_level_4` varchar(30) DEFAULT NULL,
  `dept_level_5` varchar(30) DEFAULT NULL,
  `userjob` varchar(20) NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `users` (`id`, `ip_address`, `username`, `password`, `salt`, `email`, `activation_code`, `forgotten_password_code`, `created_on`, `last_login`, `active`, `first_name`, `last_name`, `company`, `phone`) VALUES
     ('1','127.0.0.1','administrator','$2a$07$SeBknntpZror9uyftVopmu61qg0ms8Qv1yV6FG.kQOSM.9QhmTo36','','admin@admin.com','',NULL,'1268889823','1268889823','1', 'Admin','istrator','ADMIN','18312345678');
